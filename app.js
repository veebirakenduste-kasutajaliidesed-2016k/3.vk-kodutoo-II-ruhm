(function(){
   ...
   Moosipurk.prototype = {
     ...
     init: function(){
       ...
       if(localStorage.jars){
           ...
           this.jars.forEach(function(jar){
               ...
               var new_jar = new Jar(jar.id, jar.title, jar.ingredients, jar.team);
     ...
     deleteJar: function(event){
       ...
       //KUSTUTAN OBJEKTI ja uuendan local storaget
     ...
     addNewClick: function(event){
       ...
       //1) tekitan uue Jar'i
       var id = guid();
       var new_jar = new Jar(guid(), title, ingredients, team);
       ...
       //teeb päringu
       xhttp.open("GET", "save.php?id="+id+"&title="+title+"&ingredients="+ingredients+"&team="+team, true);
       xhttp.send();
   ...
   var Jar = function(new_id, new_title, new_ingredients, new_team){
     this.id = new_id;
   ...
   Jar.prototype = {
     createHtmlElement: function(){
       ...
       */
       ...
       var content = document.createTextNode(this.title + ' | ' + this.ingredients+ ' | ' + this.team);
