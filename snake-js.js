...
function SnakeJS(parentElement, config){
	...
	var defaultConfig = {
		...
		gridWidth : 35,						// Width of the game grid
		gridHeight : 20,					// Height of the game grid
		frameInterval : 200,				// Milliseconds between frames
		pointSize : 30,						// Size of one grid point
		backgroundColor : "white",			// Color of the background.
		snakeColor : "red",				// Color of the snake
		snakeEyeColor : "white",			// Color of the snake's eye
		candyColor : "blue",				// Color of the candy
		shrinkingCandyColor : "#199C2C",	// Color of the special candy that shrinks
		scoreBoardColor : "black",		// Color of the score board
		scoreTextColor : "red",			// Color of the score numbers on the score board
